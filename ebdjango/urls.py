...
urlpatterns = [
    ...
    path('guia_marketing_digital/1', views.guia_marketing_digital_1, name='guia_marketing_digital_1'),
    path('guia_marketing_digital/2', views.guia_marketing_digital_2, name='guia_marketing_digital_2'),
    path('guia_marketing_digital/3', views.guia_marketing_digital_3, name='guia_marketing_digital_3'),
    path('guia_marketing_digital/4', views.guia_marketing_digital_4, name='guia_marketing_digital_4'),
    path('guia_marketing_digital/5', views.guia_marketing_digital_5, name='guia_marketing_digital_5'),
    path('guia_marketing_digital/6', views.guia_marketing_digital_6, name='guia_marketing_digital_6'),
    path('guia_marketing_digital/7', views.guia_marketing_digital_7, name='guia_marketing_digital_7'),
    path('guia_marketing_digital/8', views.guia_marketing_digital_8, name='guia_marketing_digital_8'),
    path('guia_marketing_digital/9', views.guia_marketing_digital_9, name='guia_marketing_digital_9'),
